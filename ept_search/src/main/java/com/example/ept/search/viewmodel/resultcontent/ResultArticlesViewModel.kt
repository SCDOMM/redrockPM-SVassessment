...
sealed class ArticlesState{
    data class RefreshState(val videoList:MutableList<MetroData>): ArticlesState()
    data class LoadingMoreState( val newVideoList: MutableList<MetroData>): ArticlesState()
