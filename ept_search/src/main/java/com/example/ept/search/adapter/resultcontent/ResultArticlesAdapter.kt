 ...
 *
 */
class ResultArticlesAdapter : ListAdapter<MetroData, ResultArticlesAdapter.ArticlesViewHolder>(ArticlesDiffCallback){
    ...
    inner class ArticlesViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        val ivResultArticlesCoverItem: ImageView=itemView.findViewById(R.id.iv_result_articles_cover_item)
        val tvResultArticlesTitleItem: TextView=itemView.findViewById(R.id.tv_result_articles_title_item)
        val tvResultArticlesDescItem: TextView=itemView.findViewById(R.id.tv_result_articles_desc_item)
        val tvResultArticlesInteractItem: TextView=itemView.findViewById(R.id.tv_result_articles_interact_item)
        val ivResultArticlesStackItem: ImageView=itemView.findViewById(R.id.iv_result_articles_stack_item)
