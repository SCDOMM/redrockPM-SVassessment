 ...
 *
 */
class ResultVideosAdapter : ListAdapter<MetroData, ResultVideosAdapter.VideosViewHolder>(VideosDiffCallback){
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): VideosViewHolder {
        val view= LayoutInflater.from(parent.context).inflate(R.layout.itemview_videos,parent,false)
    ...
    inner class VideosViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        ...
        val tvResultVideosLabelItem: TextView=itemView.findViewById(R.id.tv_result_videos_label_item)
