...
sealed class CreatorsState{
    data class RefreshState(val videoList:MutableList<MetroData>): CreatorsState()
    data class LoadingMoreState( val newVideoList: MutableList<MetroData>): CreatorsState()
